 ...
 "use strict";
    ...
    function fichePlat(nomParametre) {
        ...
        success: function(data){
            ...
            document.getElementById('plats').innerHTML += '<h3>Restaurant</h3>' + tableauPlat.restaurant;
            document.getElementById('plats').innerHTML += '<button id="commander" style="display:block; margin:auto; margin-top:10px; margin-bottom:10px; border:none;" class="ui-btn ui-alt-icon ui-icon-search ui-btn-icon-left ui-nodisc-icon ui-btn-inline">Commander</button>';
